        ...
        <div class="card">
            <div class="card-body">
                <div class="right-side-struct  pull-right">
                    <a href="{{ url('/company/employee-management/create') }}" class="btn btn-info waves-effect waves-light clearfix add-new add-faicon"><i class="fa fa-plus" aria-hidden="true"></i> Add New Employee </a>
                </div>
...
<script type="text/javascript">
    $(function() {
        $('#dataTable').DataTable({
            ...
            ajax: '{!! url("/company/employee-management/employee-data") !!}',
            columns: [{
                    data: 'firstName',
                    name: 'firstName',
                    orderable: true
    ...
    $(document).on('click', '.delete', function() {
        ...
        swal({
            ...
            if (isConfirm.value === true) {
                ...
                $.ajax({
                    url: '{{ url("/company/employee-management/delete") }}' + '/' + id,
                    type: 'GET',
                    success: function() {
                        ...
                        swal(
                            ...
                            window.location.href = '{{ url("/company/employee-management") }}';
                        });
                    }
                });
            }
