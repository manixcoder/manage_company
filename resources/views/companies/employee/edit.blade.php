	...
	<div class="col-lg-12">
		<div class="card card-outline-info">
			...
			<div class="card-body">
					...
					@endif
					<form class="edit-form" method="POST" action="{{ url('/company/employee-management/'.Crypt::encrypt($employeData->id).'/update') }}" enctype="multipart/form-data">
						{{ csrf_field() }}
						<div class="form-body"> 
								...
								<div class="col-md-6">
									<div class="form-group  @error('phone') has-danger @enderror ">
										...
										<input 
											...
											id="salary" 
											name="salary" 
											value="{{ old('phone',(isset($employeData) && !empty($employeData->salary)) ? $employeData->salary : '' ) }}"
										/>
										@error('salary')
